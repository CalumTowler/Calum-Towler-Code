...
echo ISMEAR = -5       ! Smearing method 0=Gaussian, -5=tetrahedron (needs gamma and >2 kpoints) >> INCAR.born
...
echo ISMEAR = -5       ! Smearing method 0=Gaussian, -5=tetrahedron (needs gamma and >2 kpoints) >> INCAR.supercell
